...
const AVAILABLE_TABS = [
  ...
  { id: 'activities_cms', label: 'Activities Website CMS' },
  { id: 'packages', label: 'Party Packages & Pricing' },
  { id: 'birthday_page', label: 'Birthday Landing Page' },
  { id: 'faq_page', label: 'FAQ Page Editor' },
  { id: 'terms_page', label: 'Terms & Conditions Editor' },
  { id: 'privacy_page', label: 'Privacy Policy Editor' },
  { id: 'banners', label: 'Banners & Posters Manager' },
